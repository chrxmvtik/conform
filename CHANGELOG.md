## [conform 0.1.0-alpha.31](https://github.com/siderolabs/conform/releases/tag/v0.1.0-alpha.31) (2026-01-12)

Welcome to the v0.1.0-alpha.31 release of conform!
...
### Changes
<details><summary>179 commits</summary>
<p>

* [`04a62ac`](https://github.com/siderolabs/conform/commit/04a62acfa032ff7aa118e8b45990aef733932849) fix: allow ignoring individual files
* [`8584940`](https://github.com/siderolabs/conform/commit/858494024b8aa06595249092ade3641b751a117a) docs: update the pre-commit repo branch
* [`8078e02`](https://github.com/siderolabs/conform/commit/8078e02d1d2c5986bf89c3c1d46e7094520b0237) docs: fix container run option for selinux systems
* [`fadbbb4`](https://github.com/siderolabs/conform/commit/fadbbb45f38681d50593a48fb26e48b45f7da70a) chore: enable arm64 conform image
* [`a6572d2`](https://github.com/siderolabs/conform/commit/a6572d2df58f1e526a0e0694c5bfd59b04b93e7e) fix: error in checkoutt diff
* [`43d9fb6`](https://github.com/siderolabs/conform/commit/43d9fb6d85d5f01b391245805eefd258db160197) fix: create a temp dir on hook requests, not a file
* [`a316d3d`](https://github.com/siderolabs/conform/commit/a316d3d13e82ac5f8d2eae42a734f8a885cddb15) feat: add support for multiple licenses
* [`0d908eb`](https://github.com/siderolabs/conform/commit/0d908eb684629b8bc02682de36b9084cc076c6d0) chore: bump deps
* [`e2ea2cf`](https://github.com/siderolabs/conform/commit/e2ea2cf8fbd4a5ba59200235a661dad09f400895) docs: add the installation guide with aqua
* [`da80745`](https://github.com/siderolabs/conform/commit/da80745014cd94fe4893d7decc172fd06bb98c28) chore: rekres
* [`b335add`](https://github.com/siderolabs/conform/commit/b335addf6dc69bea04f85c3de4d9cf3e83756e03) docs: correct comments about feat/fix
* [`2feadaa`](https://github.com/siderolabs/conform/commit/2feadaa74eef93dd35f303582f2e82afa62a119d) chore: add no-op github workflow
* [`7d9dec0`](https://github.com/siderolabs/conform/commit/7d9dec0f2f2f72194f176324a68a5792de422f6e) chore: bump deps
* [`745a332`](https://github.com/siderolabs/conform/commit/745a332fca7023a69a58531ebbf69dfdb83da441) fix: bump action image v0.1.0-alpha.26-3-g6380738
* [`6380738`](https://github.com/siderolabs/conform/commit/6380738b7fdfc68b208ce0674c4ac1ba314ba600) fix: hard coded ref as `master`
* [`9023e3a`](https://github.com/siderolabs/conform/commit/9023e3a114677975577153025e69dcdeebf72034) feat: add multi commit support
* [`1130050`](https://github.com/siderolabs/conform/commit/113005071c9dc0444dad3985135ba70aed01cfe9) chore: rekres
* [`a121f38`](https://github.com/siderolabs/conform/commit/a121f381ffd539a6b23ff4182fe5e43ffdf02a9d) release(v0.1.0-alpha.26): prepare release
* [`940b51e`](https://github.com/siderolabs/conform/commit/940b51e3a3cd5d21077e04b002fe1aee78f3c8d1) chore: finish rename org
* [`625a1c5`](https://github.com/siderolabs/conform/commit/625a1c521989a846a8a35cd879b3e4e06c2a6b15) chore: rename org
* [`6f30715`](https://github.com/siderolabs/conform/commit/6f30715b2ad5c022ec6648be1eb547776c9b1a0a) fix: field order for breaking conventional commit
* [`421310b`](https://github.com/siderolabs/conform/commit/421310bc08e2de4935580b3963f0254e70ecb965) release(v0.1.0-alpha.25): prepare release
* [`18107a6`](https://github.com/siderolabs/conform/commit/18107a6d00cf30d420c6ef3a5c14f64efa4f385b) fix: checkout a branch only once
* [`f00081b`](https://github.com/siderolabs/conform/commit/f00081bdfeb35517095dbcbd053305e9c8ae6fc9) release(v0.1.0-alpha.24): prepare release
* [`e9bb88a`](https://github.com/siderolabs/conform/commit/e9bb88a607115a6ff0008aec919f672f981038f2) fix: don't try git checkout repository twice
* [`bb8186b`](https://github.com/siderolabs/conform/commit/bb8186be5f8d6688284621c00c04d7cec9885091) fix: update jira issue valid message
* [`785d27d`](https://github.com/siderolabs/conform/commit/785d27dc5487aa6c5b5709a898d4e982c7f88410) release(v0.1.0-alpha.23): prepare release
* [`6caaabc`](https://github.com/siderolabs/conform/commit/6caaabc0f9721d161e68593fe3ee776761bdc893) feat: allow comments before the license header
* [`9a470a1`](https://github.com/siderolabs/conform/commit/9a470a16fe05643de83db40bf3f8cb0c3452ee2f) docs: update README with the latest changes
* [`35fba60`](https://github.com/siderolabs/conform/commit/35fba6014b3ecdd155c82fd931051b90c2aa9c35) chore: use kres to setup build instructions
* [`fb43bd4`](https://github.com/siderolabs/conform/commit/fb43bd4b31cca4206f0469b1afffcb1666685ab2) feat: provide gpg identity signature check
* [`c23e2fc`](https://github.com/siderolabs/conform/commit/c23e2fc7c6159cdd3ff6b78eb7591c654171e1a8) feat: add conventional commit breaking change support
* [`0e3a28c`](https://github.com/siderolabs/conform/commit/0e3a28c994aa9a0727d48bcde91c39034a2056e1) fix: update action version
* [`0390165`](https://github.com/siderolabs/conform/commit/03901655927737cedf5c0e901f72832cde9ee03a) fix: change check_jira regexp
* [`73f334a`](https://github.com/siderolabs/conform/commit/73f334a4ac7e6a799bc71f0611674f26b9b9c3a9) fix: disallow 0 as valid jira issue id
* [`5b58100`](https://github.com/siderolabs/conform/commit/5b58100ec8619aa94eb855546ddbeb8f27a35a24) chore: bump golangci-lint and fix linting issues
* [`c5dc2e6`](https://github.com/siderolabs/conform/commit/c5dc2e6b86fa76eea7fbf37a064ca6b9962aee96) fix: change "jiraKeys" to "keys"
* [`efd7fbb`](https://github.com/siderolabs/conform/commit/efd7fbb0dbc0042f54af587ffa07a829fdc88f1c) feat: improve Jira check
* [`001de56`](https://github.com/siderolabs/conform/commit/001de5691ecce630808bc2716229d9ee700a1ab4) feat: add support for requiring a Jira issue in the header
* [`5a75e96`](https://github.com/siderolabs/conform/commit/5a75e96171ef6aaaebecfced193df379296e03d7) chore: remove gitmeta
* [`cea1ee9`](https://github.com/siderolabs/conform/commit/cea1ee90f257daa96aa09ef9ba8b1deafddf92b2) chore: bump golangci-lint and fix linting issues
* [`6e0c294`](https://github.com/siderolabs/conform/commit/6e0c294bc044bde8dc43d45e31dee3b41a97fd53) feat: implement full gitignore-style pattern matching
* [`72708f2`](https://github.com/siderolabs/conform/commit/72708f25b12786e10a7f49da584a638ac76bfe92) feat: support regex in conventional commit scope
* [`ec5e365`](https://github.com/siderolabs/conform/commit/ec5e3656494068721fa29a815ea8abf67a4922f6) fix: checkout pull requests
* [`6d1a620`](https://github.com/siderolabs/conform/commit/6d1a620acbe83af09a97468129d02a366aec9b24) fix: use text/template
* [`8212dc6`](https://github.com/siderolabs/conform/commit/8212dc6b2353af86d0f69fd0fe4458b23507a7ec) chore: update CHANGELOG
* [`b3b6e65`](https://github.com/siderolabs/conform/commit/b3b6e657fbd4c94f57b81ac95885339ff4ee1b59) feat: add spellcheck commit check
* [`8726189`](https://github.com/siderolabs/conform/commit/8726189af55c5278de18b464273b89fed024aa2a) chore: update go-git
* [`f5826e5`](https://github.com/siderolabs/conform/commit/f5826e55f29fb34194cee5233b5621501a4c2171) refactor: rename summarizer to reporter
* [`b2f63c1`](https://github.com/siderolabs/conform/commit/b2f63c178998589d9f6f0273842ca38cc425a84d) feat: move body options to dedicated field
* [`fa7df19`](https://github.com/siderolabs/conform/commit/fa7df19996ece307285da44c73f210c6cbec9207) feat(policy): add checks for header case and last character
* [`a55d411`](https://github.com/siderolabs/conform/commit/a55d411e8f9061b6ab5b8dacd96c03254f57a557) docs: update README to include pre-commit compatibility
* [`ea7199a`](https://github.com/siderolabs/conform/commit/ea7199a68e686a6b6aea9a2c7741556c89680bd1) feat: add compatibility with pre-commit.com
* [`d97b22c`](https://github.com/siderolabs/conform/commit/d97b22c1bb88575b9e7a19a33dd47f8885096db8) feat(policy): Make Conventional commit description configurable
* [`59f365a`](https://github.com/siderolabs/conform/commit/59f365afe2384aabeee5617f28ef56b7f1ed6e17) fix: Correctly return errors from command run function
* [`01f87b9`](https://github.com/siderolabs/conform/commit/01f87b956d3b317e834713a918acaa3726fc7980) docs: add installation guide to README
* [`4eb4beb`](https://github.com/siderolabs/conform/commit/4eb4beb060332b18c585161728f77aee84b46783) fix: add action.yml
* [`d9668e0`](https://github.com/siderolabs/conform/commit/d9668e05ebde8f8c3bc96abf9711665c040efb6f) fix: remove autonomy references
* [`cf1213a`](https://github.com/siderolabs/conform/commit/cf1213a49ab9e3c6682d6ad8bd12fb71a8b5effc) fix: address conform errors
* [`5637edd`](https://github.com/siderolabs/conform/commit/5637edd03905d2d7612b0a86c7ac51aee7ae00b6) feat: add server mode
* [`0076446`](https://github.com/siderolabs/conform/commit/007644608f2455688d194164d2d29a3fa58a9918) chore: Replace autonomy with talos-systems
* [`7bed912`](https://github.com/siderolabs/conform/commit/7bed9129bc73b5a6fd2b6d8c12f7c024ea4b7107) fix: checks conv commit format in firstWord
* [`365c592`](https://github.com/siderolabs/conform/commit/365c592227c7ecadf52a8d22db22fca0dea015a0) fix: set pass to false if errors in policies
* [`19dd2b8`](https://github.com/siderolabs/conform/commit/19dd2b82ab96a65ab739ff00c5d7331b1293e6ce) chore: set docker server entrypoint to dockerd to avoid TLS generation
* [`25d013c`](https://github.com/siderolabs/conform/commit/25d013c905306829da13ed14189e994bac5a8137) docs: update README
* [`3b208c1`](https://github.com/siderolabs/conform/commit/3b208c1f665672ce64673b7a89a159de67d99f85) fix: print an error message
* [`4716823`](https://github.com/siderolabs/conform/commit/4716823c79156870677e239cf229b9af3f28273d) chore: require a commit body
* [`7809e90`](https://github.com/siderolabs/conform/commit/7809e90da2a0c4a087ea83a4c2a684f77f1dfe76) chore: push images for all branches
* [`0f7ec4c`](https://github.com/siderolabs/conform/commit/0f7ec4cfec40ea0ee377c56e4d356898064df1a4) chore: fix container labels
* [`adce353`](https://github.com/siderolabs/conform/commit/adce353bae54580a95a302681cba96b2f1706a36) feat: add commit body check
* [`e66888a`](https://github.com/siderolabs/conform/commit/e66888aeba8179a34646806ec050f348ba4a7669) feat: add number of commits check
* [`b330410`](https://github.com/siderolabs/conform/commit/b33041034a6b857f140f9d1b8485da3dc4e0a939) chore: build image with host net to avoid apk hang (#133)
* [`9e94c43`](https://github.com/siderolabs/conform/commit/9e94c43cfe66aff074a8c106899104a60a64272f) chore: prepare release v0.1.0-alpha.14 (#132)
* [`ef30db9`](https://github.com/siderolabs/conform/commit/ef30db9b206a4f67cc867eff4a510bbfd2a30a2d) fix: add file header check (#131)
* [`cc97536`](https://github.com/siderolabs/conform/commit/cc975363a9254c4878cd9a20708daf523bb576cf) feat: add support for GH actions on forked repo PRs (#130)
* [`4447684`](https://github.com/siderolabs/conform/commit/4447684a4433d321f1586f90bc2d107e6e7bcb91) chore: prepare release v0.1.0-alpha.12 (#129)
* [`3be1319`](https://github.com/siderolabs/conform/commit/3be1319605a0ee934a5fdf5a0e5a050f3a7e2579) feat: add support for github status checks (#128)
* [`6f8751c`](https://github.com/siderolabs/conform/commit/6f8751cb0791a8aeeb00194db3dc9c11059c7922) feat: add checks interface (#127)
* [`0af31f8`](https://github.com/siderolabs/conform/commit/0af31f88a74b836c6c8da15504730785f7b15ee8) fix: trim whitespace while validating DCO (#126)
* [`57c9dbd`](https://github.com/siderolabs/conform/commit/57c9dbd056d607fa0be2c5e1eb4628900ef85c2c) chore: quote docker creds (#122)
* [`ebed4b3`](https://github.com/siderolabs/conform/commit/ebed4b31cc2e6f10914850ffba9cd73fca803333) feat: implement `skipPaths` option for 'license' policy (#121)
* [`c539351`](https://github.com/siderolabs/conform/commit/c5393510751f9ba440e01845eae43d423970a16b) fix: excludeSuffixes wasn't skipping any files (#120)
* [`37e0e69`](https://github.com/siderolabs/conform/commit/37e0e6973100e596f29bbf43675472c5d8236679) fix: check empty commit-msg prior to parsing (#118)
* [`1473b44`](https://github.com/siderolabs/conform/commit/1473b4462de868edcca18bb2dfd5108f0545232e) feat: change the license header to a string (#116)
* [`abfd427`](https://github.com/siderolabs/conform/commit/abfd427a40a1eb8f2ee953e2442afd353625e460) chore: prepare v0.1.0-alpha.10 release (#115)
* [`bd039e4`](https://github.com/siderolabs/conform/commit/bd039e43fde1298a388c3c75e982b08a9610c98d) fix: use mood instead of verb (#114)
* [`6ac7c2f`](https://github.com/siderolabs/conform/commit/6ac7c2f640fbcf85419fb9914b8bdcccd71570c0) fix: ensure the imperative check is against lowercase word (#112)
* [`fd6ad6c`](https://github.com/siderolabs/conform/commit/fd6ad6cdb0746bc5547b5bfc5d474c9ab84d68f7) chore: prepare v0.1.0-alpha.9 release (#111)
* [`286041a`](https://github.com/siderolabs/conform/commit/286041a7b48aa8b789bbab398de3a85f02ba87bd) docs: update README (#110)
* [`3f75846`](https://github.com/siderolabs/conform/commit/3f758468cea5db94fdd897dca4bc8c98016a5089) fix(policy): use natural language processing for imperative check (#109)
* [`5c6620a`](https://github.com/siderolabs/conform/commit/5c6620a1f544d9f3dd11cf5092efd698dc260827) feat(policy): add imperative mood check (#108)
* [`86a7d3e`](https://github.com/siderolabs/conform/commit/86a7d3e57de33b2800c5feb1deb4655d51fc151d) docs: fix code highlight in README (#107)
* [`eeb3d5c`](https://github.com/siderolabs/conform/commit/eeb3d5ce7ff602af855de37ec5f30a34f45e550c) docs: move LICENSE_HEADER to root of project (#106)
* [`f5ed717`](https://github.com/siderolabs/conform/commit/f5ed7174d6d5019e322d1acd4e9de47e1064a4f9) feat: add license header policy (#105)
* [`763d4d9`](https://github.com/siderolabs/conform/commit/763d4d94587a7000ebd67d7277d38275179184b0) docs: add conventional commits badge to README (#104)
* [`e4602b8`](https://github.com/siderolabs/conform/commit/e4602b810eace5fe01ef191d58026a60e448e9c6) chore: prepare v0.1.0-alpha.8 release (#103)
* [`116a3bf`](https://github.com/siderolabs/conform/commit/116a3bf1bd5cf6dc6026b5d3f5fd09640f67380e) fix(policy): remove commit header length from conventional commit policy (#102)
* [`2be1e1e`](https://github.com/siderolabs/conform/commit/2be1e1e7eaf5827c960d747f831a376c10a433ce) docs: update README (#101)
* [`22804ff`](https://github.com/siderolabs/conform/commit/22804ff48efae434dc3bfc7b1e775c747d5772da) chore: fix image tag (#100)
* [`e6664a9`](https://github.com/siderolabs/conform/commit/e6664a9705169e76673632bbb6c68b23b4b1194b) chore: prepare v0.1.0-alpha.7 release (#99)
* [`7646221`](https://github.com/siderolabs/conform/commit/7646221dc581b026654efdc9617c6eac76bb09a9) feat: output status in tab format (#98)
* [`e93a47e`](https://github.com/siderolabs/conform/commit/e93a47ee759d0345e9a2ad3526a64dcc1715f366) chore: push latest tag (#97)
* [`598b595`](https://github.com/siderolabs/conform/commit/598b595b47df3e87c7eae5fd997c3f01d2af859f) chore: revert base image to scratch (#96)
* [`eb6cc6d`](https://github.com/siderolabs/conform/commit/eb6cc6db46c88ecfe2099288c1aa5826185d1575) chore: add conform binary to /bin (#95)
* [`fd41a2f`](https://github.com/siderolabs/conform/commit/fd41a2f3619e35f9770dfddfc00c2f0eb94637bd) chore: use alpine:3.8 as base image (#94)
* [`36df035`](https://github.com/siderolabs/conform/commit/36df0355239e6fee6767b3b2e536d976ce76bfdd) chore: use buildkit for builds (#93)
* [`b59ae9c`](https://github.com/siderolabs/conform/commit/b59ae9c6fd5482b2558d43186b2951d34b7c6c40) feat: Add generic git commit policy (#92)
* [`76b6d7a`](https://github.com/siderolabs/conform/commit/76b6d7a2a7346c5d09de14bec6cb757f4a0ddb9d) chore: fix image push (#91)
* [`22e0f7b`](https://github.com/siderolabs/conform/commit/22e0f7bb7bf6ca5face6f75036fbe54407090699) chore: pin Kaniko to v0.6.0 (#90)
* [`9b72c17`](https://github.com/siderolabs/conform/commit/9b72c1797945a00cba940df4e47fa0fa8718f9ce) docs: fix README example (#89)
* [`5543c79`](https://github.com/siderolabs/conform/commit/5543c7908afe1d205234b3acefe883df2b359b4f) chore: fix typos (#88)
* [`349ba37`](https://github.com/siderolabs/conform/commit/349ba37ba4957efc1f99e24b5c34cb664dd0aa5e) docs: fix README (#87)
* [`8ced588`](https://github.com/siderolabs/conform/commit/8ced58895fb10576407e85edfadfbd568861e6ec) refactor: use Kaniko for builds (#86)
* [`0fdd552`](https://github.com/siderolabs/conform/commit/0fdd552a27d573cf9ecbc5e75b51b2e71fabcb09) feat: show git status (#85)
* [`76217df`](https://github.com/siderolabs/conform/commit/76217df7c54752b6805fade67a548ec45c502919) feat: remove artifacts before creating (#84)
* [`3b165b3`](https://github.com/siderolabs/conform/commit/3b165b3f8d332bb9e0c16d6e43ffeb923f5acbf7) fix(metadata): keep original version string (#82)
* [`f27917e`](https://github.com/siderolabs/conform/commit/f27917e150dc0b6f14d31a75f209457f8fa94889) fix(ci): push built images images (#83)
* [`e67dd43`](https://github.com/siderolabs/conform/commit/e67dd4363be3567a4094949ccf0d3263d8aa8dcc) chore(ci): add brigade configuration (#80)
* [`18d8905`](https://github.com/siderolabs/conform/commit/18d8905104b7db6bd05d33cbcfed65c5412cf16e) feat(metadata): add git ref (#81)
* [`5caf3b5`](https://github.com/siderolabs/conform/commit/5caf3b5c99fb0cd164b2a1f60d9eef86969bc384) feat(metadata): add original semver string (#79)
* [`d65491a`](https://github.com/siderolabs/conform/commit/d65491ab160a33ccf166bfe3e1d4ba2596792f57) feat(policy): show valid types and scopes on error (#78)
* [`954c003`](https://github.com/siderolabs/conform/commit/954c00327ea1cb6d16c646ba3a97b5bd4f47170a) fix(policy): unit test inline git config (#77)
* [`e439cd7`](https://github.com/siderolabs/conform/commit/e439cd7bee060a0c16bc6d9ac23f4e87bc46da9e) chore(ci): run go mod tidy (#76)
* [`2ac5059`](https://github.com/siderolabs/conform/commit/2ac50599f3f5944c44fa0c45790481e8f9d532b5) fix(policy): return error in conventional commit report (#75)
* [`7d19c82`](https://github.com/siderolabs/conform/commit/7d19c82835585768a7601a1745a344a347f0ee9c) chore(ci): show git status when dirty working tree (#74)
* [`4a6cc1c`](https://github.com/siderolabs/conform/commit/4a6cc1cb9529ad561372c09fd7f579694c212b1b) feat: adding command line flag for commit msg (#73)
* [`088e0a7`](https://github.com/siderolabs/conform/commit/088e0a76b6e04ca521c6b9e03e66acb03b8dfbe8) chore(*): output binaries (#72)
* [`4194aa5`](https://github.com/siderolabs/conform/commit/4194aa5004222589c36265d4649452b72fb744bd) chore(*): format .conform.yaml (#71)
* [`05cfacb`](https://github.com/siderolabs/conform/commit/05cfacb6edd0dd92bd28bbb60c91970a1dc46d3a) feat(*): omit symbol and DWARF symbol tables (#70)
* [`0f0ff02`](https://github.com/siderolabs/conform/commit/0f0ff02f6b134d2249f90c3698937b62222bfebd) refactor(policy): start policy error report at 1 (#68)
* [`4aaf049`](https://github.com/siderolabs/conform/commit/4aaf04924064dfcaaba3d984666f1fd4f4dbe4fe) chore(*): go module cleanup (#67)
* [`fbc195c`](https://github.com/siderolabs/conform/commit/fbc195c8055a61bc2f45cf95f29957aea2e429b3) chore(*): disable cgo (#66)
* [`155b036`](https://github.com/siderolabs/conform/commit/155b0369ddf5bea3b162067b804a487fb3b634e2) feat(metadata): mark SHA as dirty (#63)
* [`f39b434`](https://github.com/siderolabs/conform/commit/f39b4343fd0181dbb1ffca2c36573e6724768764) chore(*): always push latest (#65)
* [`1276371`](https://github.com/siderolabs/conform/commit/12763710cbe120102f5da965524a84b2b4d57bf1) chore(*): go modules and faster linting (#64)
* [`0a0cba3`](https://github.com/siderolabs/conform/commit/0a0cba34137d39002bf762b52d19121290be9980) feat(*): add build command (#62)
* [`aed2c22`](https://github.com/siderolabs/conform/commit/aed2c223188bb7ee04046976a4e1249e1451d8ca) fix(policy): update regex to allow optional scope (#61)
* [`1933d19`](https://github.com/siderolabs/conform/commit/1933d192d81bfb67150be634905179bf4fe183e1) fix(pipeline): nil pointer when no defined pipeline (#60)
* [`7fd1e89`](https://github.com/siderolabs/conform/commit/7fd1e89c567df89bbc16449182ec10a9ce2e5c18) feat(fmt): add fmt command (#59)
* [`42c5d09`](https://github.com/siderolabs/conform/commit/42c5d09d8189e222a5785232f98b000bc869228f) feat(docker): expose the image name and tag separately (#58)
* [`5a73ea6`](https://github.com/siderolabs/conform/commit/5a73ea6ed7490f91995e9fb916213226ac50fb01) feat(git): recursively search for .git in parent directories (#56)
* [`1e57715`](https://github.com/siderolabs/conform/commit/1e577157c87a76461c8576a7f6b696ab3704c53f) fix(cli): invalid variable message (#53)
* [`72061b1`](https://github.com/siderolabs/conform/commit/72061b11a121bd6ba1ad6e25a0e66059a09fc5d8) feat(metadata): allow users to specify variables (#52)
* [`4b7b903`](https://github.com/siderolabs/conform/commit/4b7b903aac3671f839115f6240d4e12e5256e742) fix(policy): strip leading newline from commit message (#50)
* [`779bf93`](https://github.com/siderolabs/conform/commit/779bf930fb4cdbe2d94b39c2218f9b2854efaf7a) fix(pipeline): don't show stdout of artifact extraction (#49)
* [`0373fea`](https://github.com/siderolabs/conform/commit/0373fea42e663c91e512fe1c144721b299bae457) feat(*): services, skip flag, and UX improvements (#43)
* [`c53f523`](https://github.com/siderolabs/conform/commit/c53f52307152a6392835e23797f1432799a1e0cc) feat(renderer): allow templates to be retrieved from URL (#41)
* [`c2cb181`](https://github.com/siderolabs/conform/commit/c2cb1818f44f6b5d0dd73b2e0de64c70972fd72e) refactor(*): minor changes (#37)
* [`19e4656`](https://github.com/siderolabs/conform/commit/19e4656da53bc707af536efa49ceae4edc82de8c) refactor(*): add enforcer package (#33)
* [`26ff570`](https://github.com/siderolabs/conform/commit/26ff570fbe76d82ac5e571eb709efa9e9459c99c) chore(ci): use autonomy/golang:1.8.3 for build and test tasks (#32)
* [`44d4ef0`](https://github.com/siderolabs/conform/commit/44d4ef0256dd48965eabcbeade2838bb9ccdeaea) fix(policy): check the entire commit header length (#31)
* [`bd3404a`](https://github.com/siderolabs/conform/commit/bd3404a593d9e891a2c70aadf25add80e7a71ae5) refactor(*): rename conform directory to pkg (#30)
* [`daa39f3`](https://github.com/siderolabs/conform/commit/daa39f36a0376e1e4767da5e43d13f0ec1b2c838) docs(readme): update example (#28)
* [`9383d3e`](https://github.com/siderolabs/conform/commit/9383d3ebab5b14c186fc84299c76cfa4d404a9c6) feat(policy): enforce 72 character limit on commit header (#29)
* [`6a115cf`](https://github.com/siderolabs/conform/commit/6a115cfbe5a750b8a4aecea0467adf258fa25e74) chore(ci): check if not a PR (#27)
* [`ec732ae`](https://github.com/siderolabs/conform/commit/ec732ae306598fd292c3b0e8ce38359d0da71aae) chore(ci): build on master or tag (#26)
* [`ba44e03`](https://github.com/siderolabs/conform/commit/ba44e03d35ce19ce0372970609110c46aa6be7ed) chore(ci): skip branch check in script (#25)
* [`6cece44`](https://github.com/siderolabs/conform/commit/6cece4467af854f47b5066a226ac43e4f8c60ecb) chore(ci): use Travis deploy (#24)
* [`31f79af`](https://github.com/siderolabs/conform/commit/31f79af8dc091d9bcb7ef9f2e3b6647ab12ef553) chore(ci): update script to print useful information (#23)
* [`a18332a`](https://github.com/siderolabs/conform/commit/a18332af48f1e5ddb5308ac9ed3d1ff030e96a1b) fix(metadata): nil version struct (#22)
* [`3ae8e5f`](https://github.com/siderolabs/conform/commit/3ae8e5f0f333d1bc44e31fb256448f36f4619332) refactor(*): make conform.yaml a dotfile (#21)
* [`936b64e`](https://github.com/siderolabs/conform/commit/936b64e1b6169a28ab254455df3457366d04a5fa) refactor(*): complete rewrite (#20)
* [`03caad0`](https://github.com/siderolabs/conform/commit/03caad0cb1a02e8bf688557f21c3bd58b2c69fdc) feat(policy): add policy enforcement; enforce git commit policy (#17)
* [`9927a05`](https://github.com/siderolabs/conform/commit/9927a05dc80f0ce8eb7a4cafaf49efc1db28cc57) refactor(docker): read Dockerfile from stdin (#16)
* [`dcc9fe5`](https://github.com/siderolabs/conform/commit/dcc9fe5417f820fe4c2b1673b41f7022d536c80d) chore(ci): use the stable Docker repository (#15)
* [`d37461a`](https://github.com/siderolabs/conform/commit/d37461ae38f87d0701dfe492ef497cef321b26f9) refactor(git): use go-git instead of shelled out commands (#14)
* [`71fa116`](https://github.com/siderolabs/conform/commit/71fa116a49757e7357467c7e21bac29ceab86beb) Add pre-release to git info (#12)
* [`fd5c627`](https://github.com/siderolabs/conform/commit/fd5c62790011ef68bf96aa7720e88839c61c1c11) Use gometalinter and fix linting errors (#11)
* [`0e66ba1`](https://github.com/siderolabs/conform/commit/0e66ba1b6fa9e60296fb0276d18c13d1bad88d10) Fix deploy on tags (#10)
* [`00fbfa8`](https://github.com/siderolabs/conform/commit/00fbfa845376925c51ead7c723ce4f5401da9df8) Use generic language in Travis build (#9)
* [`925dabf`](https://github.com/siderolabs/conform/commit/925dabfde80372ee952da4d4584f1e5fbf60c087) Remove 'version' from path of variables set at build time (#8)
* [`aa8ced7`](https://github.com/siderolabs/conform/commit/aa8ced7d725629190bba8e47f29bb24bb1bae3ad) Fix package path of variables set at build time (#7)
* [`ad8eef9`](https://github.com/siderolabs/conform/commit/ad8eef9901a2a1800751361453112ba5766cde6b) Fix copy of artifact in image template (#6)
* [`6311568`](https://github.com/siderolabs/conform/commit/6311568530d96447d9f6b1de673a777532fe6fd6) Set execution bit of deploy script (#5)
* [`92643d5`](https://github.com/siderolabs/conform/commit/92643d5fd3e0a46a4e937b6ec947b26f06f043d1) Stream script output and deploy on master or tags (#4)
* [`81055ed`](https://github.com/siderolabs/conform/commit/81055ed01af331bf8d5c5596cf8dfe26f608e532) Return script output on error (#3)
* [`426abe1`](https://github.com/siderolabs/conform/commit/426abe1aea53e396d5a2da260d71f75372344cc1) Fix bad tag detection and setup CI (#2)
* [`0c55035`](https://github.com/siderolabs/conform/commit/0c55035ee0f2129a4cb63d07da834dc2210684f1) Initial implementation (#1)
* [`994ba0b`](https://github.com/siderolabs/conform/commit/994ba0b98618d07e29e21092f6929ac9399e6fd5) Initial commit
</p>
</details>

### Changes since v0.1.0-alpha.30
...
## [conform 0.1.0-alpha.26](https://github.com/siderolabs/conform/releases/tag/v0.1.0-alpha.26) (2022-07-04)
